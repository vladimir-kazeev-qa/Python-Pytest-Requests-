...
response_create_pokemon = requests.post(url = f'{Vars.URL}/pokemons', headers = Vars.HADER, json = body_create_pokemon)
...
response_rename_pokemon = requests.put(url = f'{Vars.URL}/pokemons', headers = Vars.HADER, json = body_rename_pokemon)
...
response_addPokeball_pokemon = requests.post(url = f'{Vars.URL}/trainers/add_pokeball', headers = Vars.HADER, json = body_addPokeball_pokemon)
